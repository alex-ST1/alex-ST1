// Modern SVG Icons (Lucide / SF Pro Aesthetic)
const Icons = {
  wallet: (cls = '', size = 20) => `
...
function getIcon(name, cls = '', size = 20) {
  if (Icons[name]) {
    return Icons[name](cls, size);
  }
  return '';
}
