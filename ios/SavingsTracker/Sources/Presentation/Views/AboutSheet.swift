...
public struct AboutSheet: View {
    ...
    public let authorName: String = "Sagar Thapa"
    public let authorEmail: String = "thapasagar102@gmail.com"
    ...
    @ViewBuilder
    private var developerCardView: some View {
    ...
    @ViewBuilder
    private var emailActionSection: some View {
        VStack(spacing: 10) {
            HStack {
    ...
    @ViewBuilder
    private var featuresCardView: some View {
        VStack(alignment: .leading, spacing: 14) {
